...
public class LekoviIzmena extends JFrame {
...
//		odjava.setHorizontalAlignment(SwingConstants.RIGHT);
		...
		JPanel izmeniti = new JPanel();
		izmeniti.setBackground(new Color(230, 255, 251));

		panCenter.add(menuPan, BorderLayout.NORTH);
		panCenter.add(izmeniti, BorderLayout.CENTER);

		izmeniti.setLayout(new BorderLayout());

		showIzmeniPanel(izmeniti);
	}

	private void showIzmeniPanel(JPanel izmeniti) {
		...
		izmeniti.add(sifra, BorderLayout.PAGE_START);
		...
		izmeniti.add(Proiz, BorderLayout.PAGE_START);
		...
		izmeniti.add(Cena, BorderLayout.PAGE_START);

		JPanel izmena = new JPanel();
		izmena.setBackground(new Color(230, 255, 251));
		...
		izmena.add(btnDodaj);
		izmeniti.add(izmena);
		izmeniti.setLayout(new FlowLayout(FlowLayout.CENTER));
